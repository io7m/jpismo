...
public final class PTextRendererGL30Test extends PTextRendererContract
{
  @Override public JCGLImplementationType getGLImplementation()
  {
    return PJOGLTestContext.makeContextWithOpenGL3_0(true);
  }
  ...
  {
    return PJOGLTestContext.isOpenGL30Supported();
  }
}
