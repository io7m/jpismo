...
public final class ShowTextAtlasFixed implements Example
{
  private CompiledText           compiled_text;
  private Font                   font;
  private ArrayList<String>      lines;
  private TextRendererAtlasFixed renderer;
      ...
      TextCacheException
  {
    ...
    this.renderer = new TextRendererAtlasFixed(gl, this.font, log);
