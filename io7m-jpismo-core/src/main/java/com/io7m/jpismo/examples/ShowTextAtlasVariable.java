...
public final class ShowTextAtlasVariable implements Example
{
  private CompiledText              compiled_text;
  private Font                      font;
  private ArrayList<String>         lines;
  private TextRendererAtlasVariable renderer;
      ...
      TextCacheException
  {
    ...
    this.renderer = new TextRendererAtlasVariable(gl, this.font, log);
