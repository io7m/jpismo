...
public final class TextureFilterMagnificationGenerator implements
  Generator<TextureFilterMagnification>
{
  ...
  public TextureFilterMagnificationGenerator()
  {
  ...
  {
    final TextureFilterMagnification[] v =
      TextureFilterMagnification.values();
